(() => {
  ...
  function item(group,{deck,favorites,covers,canAdd,db}){
    ...
    return `<article class="collection-item character-item" data-character="${esc(key(c))}" data-element="${c.element}" style="--character-color:#${data.elements[c.element]?.color||'93AAA5'}">
