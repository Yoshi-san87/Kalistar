...
const grants={guard:'grantGuard',heart:'grantReraise',clover:'grantClover',potion:'grantPotion'};
const choices={guard:'aiGuardChoice',heart:'aiReraiseChoice',clover:'aiCloverChoice',potion:'aiPotionChoice'};
