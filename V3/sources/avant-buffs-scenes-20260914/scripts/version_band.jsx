...
function kalistarVersionBand(doc, title, parent) {
 ...
 for(var i=0;i<2;i++) {
  ...
  disc(prefix+' - joint',x,1160,63,'101722');
  disc(prefix+' - cuivre',x,1160,59,'AF8580');
  disc(prefix+' - filet',x,1160,56,'E4CABC');
  disc(prefix+' - ombre',x,1160,53,'544B59');
  disc(prefix+' - email',x,1160,50,'0A2033');
 }
