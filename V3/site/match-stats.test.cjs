...
test('All five support types count the caster; ally gifts and unchanged refreshes are distinct',()=>{
 for(const [face,key,grant] of [['mana','potions','grantPotion'],['retry','clovers','grantClover'],['revive','hearts','grantReraise'],['buff_atk','physical','grantPhysical'],['guard','guards','grantGuard']]){
