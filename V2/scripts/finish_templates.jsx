...
(function(){
 ...
 for(var i=0;i<cards.length;i++){
  ...
  while(doc.layerComps.length)doc.layerComps[0].remove();
  ...
  if(c.id=='00000001'){var flat=doc.duplicate('SANS_CRISTAL_APERCU',true);flat.changeMode(ChangeMode.RGB);flat.saveAs(new File(R+'verification/MASTER_SANS_CRISTAL.png'),new PNGSaveOptions(),true);flat.close(SaveOptions.DONOTSAVECHANGES);}
 ...
 return cards.length+' templates: numeric alternatives and no-crystal layer comps ready';
})();
