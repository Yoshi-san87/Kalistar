...
var outPath = "C:/Users/guill/Documents/Doc/GP/Cartes/Kalistar/Templates/Template_Kalistar_Card_PROPRE_layers.txt";
...
function walk(container, depth, lines) {
    for (var i = 0; i < container.layers.length; i++) {
        ...
        if (layer.typename === "LayerSet") walk(layer, depth + 1, lines);
    }
}

var file = new File(psdPath);
if (!file.exists) throw new Error("PSD introuvable: " + psdPath);
