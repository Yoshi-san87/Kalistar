...
const items = [
  { n: 1, title: 'Le charmeur insolent', file: '01-charmeur-insolent.png', source: 'exec-7cad6653-b10b-40c3-be39-6edef83b0d2c.png', crop: [460, 20, 390, 440] },
  { n: 2, title: 'Le marquis naufrage', file: '02-marquis-naufrage.png', source: 'exec-6aab9171-a196-4fac-ad6a-558ef21c554c.png', crop: [300, 10, 420, 470] },
  { n: 3, title: 'Le flambeur', file: '03-flambeur.png', source: 'exec-2fc079af-d648-481f-b862-3c471b229d35.png', crop: [285, 20, 390, 440] },
  { n: 4, title: 'Le poete des quais', file: '04-poete-des-quais.png', source: 'exec-be6d54fd-8a0d-419b-9c7b-196434537e04.png', crop: [355, 30, 430, 480] },
  { n: 5, title: 'Le cabotin magnifique', file: '05-cabotin.png', source: 'exec-2bf50315-f7bb-409a-8a5c-15a81a68d041.png', crop: [425, 15, 405, 455] }
];
...
async function main() {
  ...
  for (const [i, item] of items.entries()) {
    ...
    records.push({ ...item, source: sourcePath, width: meta.width, height: meta.height, sha256: sha, exactCopy: sha === hash(sourcePath), prompt: `prompt-0${item.n}.txt`, promptSha256: hash(path.join(__dirname, `prompt-0${item.n}.txt`)) });
  }
