...
(function () {
    ...
    var root = File($.fileName).parent.parent.parent.parent.parent.fsName.replace(/\\/g, '/') + '/';
    ...
    return K.lifecycle(function (life) {
        ...
        var doc = life.track(app.documents.add(897, 1497, 300, 'Kalistar - Cloud FF7 - ESSAI', NewDocumentMode.RGB, DocumentFill.TRANSPARENT, 1, BitsPerChannelType.EIGHT, 'sRGB IEC61966-2.1'));
        ...
        for (var i = 0; i < plan.layers.length; i++) {
            ...
            var layer, b;
            if (spec.name === 'FACTION - FF7 - meteor') {
        ...
        doc.info.caption = 'Kalistar V4 | PRIVATE CROSSOVER EXPERIMENT | FF7 | NOT PUBLISHED | ' + card.id;
        K.save(doc, home + 'CLOUD_FF7_V4_01.psd', home + 'CLOUD_FF7_V4_01.png');
        var reopened = life.open(home + 'CLOUD_FF7_V4_01.psd');
        ...
        return 'Cloud FF7 experiment composed: ' + card.id;
    });
})();
