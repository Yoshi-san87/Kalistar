(function(root,factory){
...
})(typeof window==='undefined'?globalThis:window,T=>{
  'use strict';
  ...
  function rows(data,db,state,now=Date.now()){
    ...
    for(const c of data.cards){
      ...
      const collab=['FF7','FF8','NieR'].includes(c.faction)?c.faction:'kalistar';
