...
const CODE = ['assemble.cjs', 'model.cjs', 'assets.cjs', 'preservation.cjs', 'capture.cjs', 'catalogue.cjs', 'build.cjs', 'compose.jsx', 'canonical.cjs', 'regression.cjs', 'regression.jsx', 'publish.cjs'];
