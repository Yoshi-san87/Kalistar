function composeFF7(home, root) {
    ...
    return K.lifecycle(function (life) {
        ...
        var doc = life.track(app.documents.add(897, 1497, 300, 'Kalistar FF7 - '+card.name, NewDocumentMode.RGB, DocumentFill.TRANSPARENT, 1, BitsPerChannelType.EIGHT, 'sRGB IEC61966-2.1'));
        ...
        doc.info.caption = 'Kalistar V4 | FF7 fan crossover | '+card.id+' | Cadre valide, texte natif et objets incorpores';
