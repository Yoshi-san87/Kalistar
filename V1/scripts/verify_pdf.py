...
doc=pdfium.PdfDocument(str(R/'impression/KALISTAR_V1_12_CARTES.pdf'))
results=[]
...
doc.close()
reader=PdfReader(R/'impression/KALISTAR_V1_12_CARTES.pdf')
...
a=Image.open(R/'verification/MOMO_reference_rgb.png').convert('RGB')
b=Image.open(R/'cartes/04_PYRO_DARNAKO.png').convert('RGB')
Image.blend(a,b,.5).save(R/'verification/SUPERPOSITION_MOMO_DARNAKO.png')
print('PDF: 12 pages rendered at 300 dpi; 12 correct decoded IDs; CMYK image objects and source output intent.')
